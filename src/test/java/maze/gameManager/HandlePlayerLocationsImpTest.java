    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(
                new Object[][]{
                        ...
                        {10, 3, 0, 3, 4, 10,Enums.DirectionsEnum.EAST},
                        {8, 3, 9, 3, 4, 10,Enums.DirectionsEnum.EAST},
                        {0, 4, 9, 4, 4, 10,Enums.DirectionsEnum.WEST},
                        {2, 7, 1, 7, 4, 10,Enums.DirectionsEnum.WEST},
                        {3, 9, 3, 0, 4, 10,Enums.DirectionsEnum.SOUTH},
                        {6, 2, 6, 3, 4, 10,Enums.DirectionsEnum.SOUTH},
