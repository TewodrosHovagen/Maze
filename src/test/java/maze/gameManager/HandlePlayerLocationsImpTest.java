...
public class HandlePlayerLocationsImpTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(
                new Object[][]{
                        {0, 0, 3, 0, 4, 10,Enums.DirectionsEnum.UP},
                        {1, 1, 0, 1, 4, 10,Enums.DirectionsEnum.UP},
                        {3, 9, 3, 0, 4, 10,Enums.DirectionsEnum.RIGHT},
                        {3, 8, 3, 9, 4, 10,Enums.DirectionsEnum.RIGHT},
                        {1, 0, 1, 9, 4, 10,Enums.DirectionsEnum.LEFT},
                        {2, 7, 2, 6, 4, 10,Enums.DirectionsEnum.LEFT},
                        {3, 9, 0, 9, 4, 10,Enums.DirectionsEnum.DOWN},
                        {2, 6, 3, 6, 4, 10,Enums.DirectionsEnum.DOWN},
                        ...
                        {1, 2, 1, 2, 4, 10,Enums.DirectionsEnum.BOOKMARK}
                }
        );
    }

    public HandlePlayerLocationsImpTest(int rowPosition, int colPosition, int rowExpectedPosition, int colExpectedPosition,int rows, int columns, Enums.DirectionsEnum direction) {
